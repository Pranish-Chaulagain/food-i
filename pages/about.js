        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-10">
          <div className="md:py-10">
            ...
            <p className="text-sm md:text-base mb-3">
              ...
              food enthusiasts who believe that technology can revolutionize the
              way we order and enjoy food. Our mission is to make the process of
              ordering food as simple and convenient as possible, while also
              providing a seamless and personalized experience for each and
              every one of our customers.
            </p>
            <p className="text-sm md:text-base mb-3">
              We are passionate about working with local restaurants and food
              vendors to bring you a wide range of delicious and unique options,
              all available at your fingertips. Whether you're craving a classic
              burger and fries or something a bit more exotic, our platform has
              something for everyone. So why wait in line or settle for mediocre
              food? With our food ordering system, you can sit back, relax, and
              let us bring the restaurant experience to you.
            </p>
            <ul className="list-disc pl-5 text-sm md:text-base">
              ...
              <li>
                Our mission is to provide a simple, convenient, and personalized
